...
public class CarConstructor {
	...
	//매개변수가 없는 생성자를 기본생성자라고 하면
	//생성자를 정의하지 않았을 때 기본으로 제공된다.
	//생성자는 객체를 생성하면서 속성등을 초기화할 때 주로 사용한다.
...
//	}
	...
	//속성 변수명과 일치시키는 게 관례적임
	//매개변수가 있는 생성자를 생성하면 기본생성자가 제공되지 않기 때문에
	//항상 기본생성자 먼저 정의를 한다음 다른 생성자들을 정의한다.
	public CarConstructor(String company, String model, String color) {
